In this experiment you will compare Self Prompting TextCtrl with regular TextCtrl.

Self Prompting TextCtrl weights: /home/ekim339/projects/SD3.5/checkpoints/self_prompting_checkpoint-00015000
Regular TextCtrl weights: /home/ekim339/projects/SD3.5/networks/TextCtrl/weights
...
1. Use regular TextCtrl to edit the text. Randomly sample 5 characters and use it as a target text. You will generate both capitalized target text and lowercase target text. Using the 100 noise pertubed images discussed previously, edit the source text to target text.

e.g. sampled characters: abcde <br/>
-> then edit the source text to both 'abcde' and 'ABCDE'

2. Repeat the same thing with Self Prompting TextCtrl 

3. Use OCR detector to detect the generated texts from regular and self prompting TextCtrl. Compute the metrics ACC, NED, and CER using the true target text and detected target text. Report the mean and standadard variations of these metrics for regular and self prompting TextCtrl. Store the results in csv file.

In csv, you will store two tables, each for capitalized target text and lowercase target text.
- each table will have regul TextCtrl and Self Prompting TextCtrl on rows and metrics on columns (mean of ACC, std of ACC, mean of NED, std of NED, mean of CER, std of CER)
...
1. Use regular TextCtrl to edit the text.
...
- The table will have regular TextCtrl and Self Prompting TextCtrl on rows and metrics on columns 
...
- There will be 2 rows; regular and self prompting
