...
from networks.scene_text_editing.checkpoints import validate_textctrl_installation
from networks.scene_text_editing.datasets import DatasetError, load_dataset
...
from networks.scene_text_editing.textctrl_inference_worker import parse_args
from networks.scene_text_editing.training import (
    TrainingError,
...
class RegressionTests(unittest.TestCase):
    ...
    def test_textctrl_backend_forwards_step_override(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with patch(
                "networks.scene_text_editing.networks.factory.subprocess.run",
